# CI DB failure (2026-08-12T13:37:44Z)

sha: 6d3091ccddbbef8e9c1bb9d64bea914d21725223
run: https://github.com/ismaileniz01-hub/kaify/actions/runs/31602184074
...
Stopping containers...
Pruned containers: [c2bbba7ac9faaed14dcc5cab66704ed8fc1968a1b0602284be88c8c4b93a7478]
Pruned volumes: [supabase_db_kaify-local]
Pruned network: [supabase_network_kaify-local]
[31mERROR: function public.purchase_market_item(uuid, text) does not exist (SQLSTATE 42883)
At statement: 8
alter function public.purchase_market_item(uuid, text) set search_path = ''[39m
```
