-- Defer Thunder skin for the invitee until they claim (Al) in-app.
-- Referrer still receives Thunder immediately when within the velocity cap.
-- Gems / referred_by_code / referrals row unchanged.
...
begin
  ...
  -- Invitee Thunder is claimed in-app (POST /api/referral/claim), not here.
