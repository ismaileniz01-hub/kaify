...
const COPY: Record<string, Record<AiCopyKey, string>> = {
  en: {
    ...
    ai_unconfigured: "The AI service is not configured right now. Check the DeepSeek API key.",
  ...
  tr: {
    ...
    ai_unconfigured: "AI servisi şu anda yapılandırılmamış. DeepSeek API anahtarını kontrol et.",
