...
export const GYM_EXERCISE_GROUPS: ExerciseGroup[] = [
  {
    ...
    exercises: [
      ...
      { key: "library.ex.gym.incline_dumbbell_bench_press" },
      { key: "library.ex.gym.decline_bench_press" },
      { key: "library.ex.gym.dumbbell_fly" },
      { key: "library.ex.gym.cable_chest_fly" },
  ...
  },
  {
    ...
    exercises: [
      ...
      { key: "library.ex.gym.wide_grip_row" },
  ...
  },
  {
    ...
    exercises: [
      ...
      { key: "library.ex.gym.machine_preacher_curl" },
      { key: "library.ex.gym.bayesian_curl" },
      { key: "library.ex.gym.spider_curl" },
  ...
  },
  {
    ...
    exercises: [
      ...
      { key: "library.ex.gym.sumo_deadlift" },
      { key: "library.ex.gym.hip_thrust" },
      { key: "library.ex.gym.cable_glute_kickback" },
      { key: "library.ex.gym.hip_abduction_machine" },
      { key: "library.ex.gym.bulgarian_split_squat" },
      { key: "library.ex.gym.calf_raise" },
      { key: "library.ex.gym.seated_calf_raise" },
      { key: "library.ex.gym.standing_calf_raise" },
  ...
  },
  {
    ...
    exercises: [
      ...
      { key: "library.ex.gym.leg_raise" },
      { key: "library.ex.gym.cable_crunch" },
      { key: "library.ex.gym.dragon_sit_up" },
      { key: "library.ex.gym.decline_sit_up" },
      { key: "library.ex.gym.flutter_kicks" },
