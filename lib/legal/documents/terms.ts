...
export const TERMS_DOCUMENT: LegalDocument = {
  ...
  intro: `These Terms of Service ("Terms") form a binding agreement between you and ${LEGAL_ENTITY} for use of Kaify Ai (${LEGAL_URL}), a subscription-based fitness and wellness technology service. By creating an account, clicking accept, or using Kaify Ai, you agree to these Terms and our Privacy Policy. If you do not agree, do not use Kaify Ai.`,
  sections: [
    {
      id: "parties",
      ...
      blocks: [
        {
          type: "p",
          text: `The contracting party is ${LEGAL_ENTITY}, operating Kaify Ai at ${LEGAL_URL}. Operational address currently published: ${LEGAL_OPERATIONAL_ADDRESS}. The registered legal entity name, company registration number, and registered office must be confirmed by counsel (see LEGAL_FACTS_REQUIRED).`,
        },
        {
          type: "p",
          text: "To the maximum extent permitted by law: (a) this agreement is solely between you and the Kaify Ai operating legal entity; (b) no founder, director, officer, employee, contractor, investor, shareholder, affiliate, or licensor is individually a party to these Terms; and (c) claims relating to Kaify Ai must be brought against the operating legal entity and not against those protected individuals, except where applicable law does not permit such limitation.",
        },
        {
          type: "p",
          text: "Paddle (the applicable Paddle group company acting as Merchant of Record) processes payment transactions. Paddle is not the provider of Kaify Ai's fitness content, AI coaches, or product functionality.",
        },
      ],
    },
    {
      ...
      blocks: [
        {
          type: "p",
          text: "No person under 16 may create an account or use Kaify Ai. By registering you represent that you are at least 16 years old and that information you provide is accurate.",
        },
        {
          type: "p",
          text: "If you are 16 or 17 and have not reached the age of legal majority in your jurisdiction, you represent that a parent or legal guardian has reviewed these Terms and the Privacy Policy and authorized your use. Kaify Ai may request age or guardian verification where reasonably necessary and may suspend or delete an account if it reasonably believes you are underage or lack required authorization.",
        },
        {
          type: "p",
          text: "A parent or guardian who permits a minor's use is responsible for supervising that use to the extent permitted by law. Kaify Ai does not claim that every user aged 16 or 17 is an adult.",
        },
      ],
    },
    {
      ...
      blocks: [
        {
          type: "p",
          text: "You form a contract with Kaify Ai when you create an account and accept these Terms (including via checkbox or equivalent control). Purchase of a subscription also forms a payment transaction with Paddle under Paddle's Buyer Terms. Electronic records of acceptance (version, timestamp, and related evidence) may be retained as described in our Privacy Policy.",
        },
      ],
    },
    {
      ...
      blocks: [
        {
          type: "p",
          text: "Kaify Ai is a fitness and general wellness technology service offering AI-assisted virtual coaches (including Alex, Maya, Leo, and Kai), streaks, analytics, optional meal and physique photo analysis, programs, and related features. Results vary. Kaify Ai does not promise any particular weight, body composition, strength, performance, health, income, or lifestyle outcome.",
        },
        {
          type: "p",
        ...
        {
          type: "p",
          text: "Kaify Ai may add, remove, modify, replace, or discontinue features, plans, content, or technical requirements. Beta or experimental features may be incomplete, inaccurate, or withdrawn without liability beyond mandatory law.",
        },
      ],
    },
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          items: [
            ...
            "Kaify Ai cannot monitor your physical condition or surroundings in real time.",
    ...
    },
    {
      ...
      blocks: [
        {
          type: "p",
          text: "Kaify Ai uses AI systems (including third-party providers such as Google Gemini for vision-related analysis and DeepSeek for conversational coaching) to generate responses, plans, and analyses. AI outputs may be incomplete, inaccurate, outdated, unsafe, or inappropriate for you. Outputs are not reviewed by a healthcare professional unless the product expressly states otherwise.",
        },
        {
          type: "ul",
          items: [
            ...
            "Kaify Ai does not guarantee availability, accuracy, uniqueness, or suitability of AI output.",
            "Kaify Ai may restrict prompts and outputs for safety, abuse prevention, or legal reasons.",
            "You must not submit inputs that infringe third-party rights or that you lack authority to provide.",
          ],
        },
        {
          type: "p",
          text: "Kaify Ai does not claim that AI providers never retain or train on data. Processing is described in the Privacy Policy and depends on provider contracts and technical controls then in force.",
        },
      ],
    },
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          items: [
            ...
            "Kaify Ai may require password or session resets, revoke sessions, or temporarily lock accounts.",
            "Kaify Ai may preserve evidence and cooperate with lawful investigations.",
            "Kaify Ai has no obligation to restore deleted user content unless required by law.",
          ],
        },
      ],
    },
    ...
    },
    {
      ...
      blocks: [
        ...
        },
        {
          type: "ul",
          items: [
            "Use Kaify Ai for illegal, fraudulent, abusive, harassing, dangerous, or deceptive purposes",
            ...
            "Use Kaify Ai to develop or benchmark a competing product without written permission where enforceable",
            "Extract datasets, workout libraries, prompts, output collections, or models",
            "Use Kaify Ai for clinical or emergency decision-making",
            "Commit chargeback fraud, refund abuse, or promotion abuse",
          ],
        },
        {
          type: "p",
          text: "Kaify Ai may investigate, restrict, suspend, or terminate accounts for violations.",
        },
      ],
    },
    {
      ...
      blocks: [
        {
          type: "p",
          text: `Kaify Ai and its licensors own all rights in the software (including source and object code), brand, trademarks, designs, UI, graphics, copy, videos, workouts, programs, databases, methodologies, algorithms, prompts, compilations, and licensed third-party content. Except for the limited license above, no rights are transferred to you.`,
        },
      ],
    },
    {
      ...
      blocks: [
        {
          type: "p",
          text: "You retain ownership of content you submit (messages, photos, profile data, notes). You grant Kaify Ai a worldwide, non-exclusive, royalty-free license to host, process, reproduce, adapt, transmit, display, secure, moderate, and otherwise operate and improve the service, including anonymized or aggregated analytics where permitted by the Privacy Policy. This license does not transfer ownership of your content.",
        },
        {
          type: "p",
          text: "You warrant that you have the rights and permissions needed for your content. Kaify Ai may remove or restrict content but is not obligated to monitor all content. Kaify Ai does not endorse user content. You are responsible for your own backups unless Kaify Ai expressly provides a backup feature.",
        },
      ],
    },
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          items: [
            ...
            "Kaify Ai generally does not receive complete payment-card numbers or full card details.",
            ...
            "Kaify Ai may assist with product-access issues but cannot override Paddle's legal or payment obligations.",
          ],
        },
      ],
    },
    {
      ...
      blocks: [
        ...
        },
        {
          type: "ul",
          items: [
            "Cancel via Paddle Customer Portal / Manage billing in Settings (or other methods Kaify Ai discloses).",
    ...
    },
    {
      ...
      blocks: [
        ...
        {
          type: "p",
          text: "Refunds and statutory withdrawal / cooling-off rights (where they apply to digital content or services) are processed under Paddle's Buyer Terms and Refund Policy. Kaify Ai may provide discretionary assistance but does not promise a refund outside applicable law and Paddle's approved process. Refunds may be denied for fraud, abuse, manipulation, or repeated refund misuse, subject to law. A successful refund or chargeback may result in suspension or removal of corresponding paid access.",
        },
        {
          type: "p",
    ...
    },
    {
      ...
      blocks: [
        {
          type: "p",
          text: "Kaify Ai may introduce new plans and change subscription prices for future billing periods. Price changes do not retroactively affect a billing period already paid for. For an existing recurring subscription, an increased price may take effect on a future renewal after notice through Kaify Ai, Paddle, or both. Where applicable law requires affirmative consent, the increased price will not be charged without that consent. If you do not accept the new price, the subscription may remain at its existing price where Kaify Ai permits, or it may expire at the end of the then-current billing period. You may cancel before the new price takes effect. Taxes, currency conversion, and payment-method charges may vary independently where permitted.",
        },
        {
          type: "p",
          text: "Creating a new catalog price does not automatically change existing subscriptions. Updates must use the proper Paddle Billing process. Kaify Ai should preview proration before user-initiated plan changes. Terms wording alone is not a substitute for required notices or consent.",
        },
      ],
    },
    {
      ...
      blocks: [
        {
          type: "p",
          text: "Kaify Ai may suspend or terminate access for Terms violations, non-payment, chargebacks or suspected payment abuse, fraud or security threats, dangerous or unlawful conduct, IP misuse, requests from Paddle, legal or regulatory obligations, risk to Kaify Ai/users/third parties, extended inactivity where disclosed, or discontinuation of the service. Immediate action may be taken for serious security, fraud, safety, or legal threats. Where reasonable and legally required, Kaify Ai will provide notice and an appeal channel via " +
            SUPPORT_EMAIL +
            ".",
        },
        {
    ...
    },
    {
      ...
      blocks: [
        {
          type: "p",
          text: `If you use Kaify Ai in a business capacity, you will indemnify and hold harmless ${LEGAL_ENTITY} and its directors, officers, employees, and agents from claims arising from your unlawful use, Terms violations, user content, infringement of third-party rights, fraud, account misuse, or regulatory claims caused by your conduct, to the extent permitted by law.`,
        },
        {
          type: "p",
          text: "For consumers, indemnity obligations apply only to the extent enforceable in your jurisdiction and do not shift Kaify Ai's own fault to you where prohibited.",
        },
      ],
    },
    {
      ...
      blocks: [
        ...
        {
          type: "p",
          text: `Contact ${SUPPORT_EMAIL} first to attempt informal resolution within 30 days. Kaify Ai does not impose a global class-action waiver or mandatory US-style arbitration in these Terms. Any arbitration or class-action provisions would appear only in counsel-approved regional addenda, if any.`,
        },
      ],
    },
    {
      ...
      blocks: [
        {
          ...
          items: [
            ...
            "Assignment: Kaify Ai may assign to an affiliate, successor, purchaser, or acquirer; you may not assign without consent except where mandatory law allows.",
            "Electronic communications: you consent to receive notices electronically.",
            "Force majeure: Kaify Ai is not liable for delays beyond reasonable control.",
