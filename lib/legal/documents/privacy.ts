  ...
  sections: [
    {
      ...
      blocks: [
        ...
        {
          type: "p",
          text: `Paddle processes payment transactions as Merchant of Record and publishes its own Privacy Notice (${PADDLE_PRIVACY_URL}). Kaify and Paddle do not have the same privacy role: Paddle typically acts as an independent controller for transaction and payment data it collects to sell and bill the product; Kaify receives subscription status, entitlements, and limited billing identifiers needed to provide access.`,
        },
      ],
    },
    {
      ...
      blocks: [
        {
          type: "p",
          text: "This Policy covers the Kaify website and application, account creation, coaching features, analytics, optional photo analysis, subscriptions, and related communications. It does not cover third-party websites linked from Kaify except as we describe our sharing with service providers.",
        },
      ],
    },
    {
    ...
    },
    {
      ...
      blocks: [
        {
          type: "p",
          text: "We collect data you provide directly, data generated by your use of Kaify, data from authentication providers you choose, and payment/entitlement data from Paddle. We do not buy health dossiers from data brokers for Kaify coaching.",
        },
      ],
    },
    {
    ...
    },
    {
      ...
      blocks: [
        ...
        {
          type: "p",
          text: "Kaify does not sell personal health data. Kaify does not use health data for unrelated advertising, data brokerage, or undisclosed model training. If product behavior ever changes, this Policy and consents must be updated before such use.",
        },
      ],
    },
    {
    ...
    },
    {
      ...
      blocks: [
        {
          type: "p",
          text: "Depending on your location, you may have rights to access, rectify, erase, restrict, port, object, withdraw consent, and lodge a complaint with a supervisory authority. US state residents may have additional rights (know, delete, correct, opt out of sale/share/targeted advertising where applicable). Kaify's position is that it does not sell personal information as 'sale' is commonly defined; if that changes, we will update this Policy.",
        },
        {
          type: "p",
