...
| TD-003 | Expand coverage gate to `lib/services/**` | Service regression detection | Eng | Q4 2026 | In progress — pure extracts (`paddle-period`, `meeting-week`, `count-consecutive-rest-days`, `resolve-api-path`) gated; full services still deferred |
