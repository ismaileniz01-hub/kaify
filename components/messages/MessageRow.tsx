    ...
    >
      ...
      <div className="min-w-0 flex-1">
        <div className="flex min-w-0 items-baseline gap-2">
          <p className="max-w-[65%] shrink-0 truncate text-sm font-semibold text-white">{name}</p>
          <span className="type-caption min-w-0 truncate type-muted">{role}</span>
        </div>
      ...
      <ChevronRight
        className="h-3.5 w-3.5 shrink-0 text-zinc-400 transition-transform group-hover:translate-x-0.5 group-hover:text-zinc-300 rtl:rotate-180 rtl:group-hover:-translate-x-0.5"
        aria-hidden
      />
    </Link>
  );
