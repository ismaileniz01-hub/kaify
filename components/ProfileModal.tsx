            ...
            <div className="mt-6 grid w-full grid-cols-2 gap-3">
              <div className="flex items-center gap-3 rounded-xl bg-white/5 px-4 py-3 ring-1 ring-white/5">
                ...
                <div className="flex flex-col">
                  <span className="text-[10px] text-zinc-500">Cinsiyet</span>
              ...
              <div className="flex items-center gap-3 rounded-xl bg-white/5 px-4 py-3 ring-1 ring-white/5">
                ...
                <div className="flex flex-col">
                  <span className="text-[10px] text-zinc-500">Boy</span>
              ...
              <div className="flex items-center gap-3 rounded-xl bg-white/5 px-4 py-3 ring-1 ring-white/5">
                ...
                <div className="flex flex-col">
                  <span className="text-[10px] text-zinc-500">Kilo</span>
              ...
              <div className="flex items-center gap-3 rounded-xl bg-white/5 px-4 py-3 ring-1 ring-white/5">
                ...
                <div className="flex flex-col">
                  <span className="text-[10px] text-zinc-500">Konum</span>
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 backdrop-blur-sm">
      <div className="relative mx-4 w-full max-w-sm overflow-hidden rounded-3xl border border-white/10 bg-zinc-900 shadow-2xl">
        {/* Header */}
        <div className="flex items-center justify-between border-b border-white/5 px-5 py-4">
          <h2 className="text-sm font-semibold text-white">Profili Düzenle</h2>
          <button
        ...
        <div className="flex flex-col gap-4 px-6 py-6">
          ...
          <div className="flex flex-col gap-1.5">
            <label className="text-[11px] font-medium uppercase tracking-wider text-zinc-500">İsim</label>
            <input
              type="text"
              value={form.name}
          ...
          {/* Bio */}
          <div className="flex flex-col gap-1.5">
            <label className="text-[11px] font-medium uppercase tracking-wider text-zinc-500">Hakkımda</label>
            <textarea
              value={form.bio}
          ...
          {/* Cinsiyet */}
          <div className="flex flex-col gap-1.5">
            <label className="text-[11px] font-medium uppercase tracking-wider text-zinc-500">Cinsiyet</label>
            <select
              value={form.gender}
            ...
            >
              ...
              <option value="Kadın" className="bg-zinc-900">Kadın</option>
              <option value="Belirtmek istemiyorum" className="bg-zinc-900">Belirtmek istemiyorum</option>
            </select>
          </div>
          ...
          <div className="grid grid-cols-2 gap-3">
            <div className="flex flex-col gap-1.5">
              <label className="text-[11px] font-medium uppercase tracking-wider text-zinc-500">Boy</label>
              <input
                type="text"
                value={form.height}
                onChange={(e) => handleChange("height", e.target.value)}
                className="w-full rounded-xl border border-white/10 bg-white/5 px-4 py-2.5 text-sm text-white outline-none transition placeholder:text-zinc-600 focus:border-purple-500/50 focus:bg-purple-500/5"
                placeholder="örn. 178 cm"
              />
            </div>
            <div className="flex flex-col gap-1.5">
              <label className="text-[11px] font-medium uppercase tracking-wider text-zinc-500">Kilo</label>
              <input
                type="text"
                value={form.weight}
                onChange={(e) => handleChange("weight", e.target.value)}
                className="w-full rounded-xl border border-white/10 bg-white/5 px-4 py-2.5 text-sm text-white outline-none transition placeholder:text-zinc-600 focus:border-purple-500/50 focus:bg-purple-500/5"
                placeholder="örn. 75 kg"
              />
            </div>
          </div>
          ...
          {/* Konum */}
          <div className="flex flex-col gap-1.5">
            <label className="text-[11px] font-medium uppercase tracking-wider text-zinc-500">Konum</label>
            <input
              type="text"
              value={form.location}
          ...
          <div className="flex flex-col gap-1.5">
            <label className="text-[11px] font-medium uppercase tracking-wider text-zinc-500">Durum</label>
