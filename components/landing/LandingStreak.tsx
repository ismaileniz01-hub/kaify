        ...
        >
          ...
          <div className="landing-streak-bridge" aria-hidden>
            ...
            <p className="landing-streak-days">
              {t("landing.streak.days", { count: 120 })}
            </p>
          </div>

          <div className="landing-streak-stage landing-streak-stage--lv4 focus-visible:outline-2 focus-visible:outline-purple-400 focus-visible:outline-offset-4" tabIndex={0}>
            <div className="landing-streak-badge landing-streak-badge--lv4">
              <Flame className="h-4 w-4" />
              {t("landing.streak.level", { level: 4 })}
            </div>
            <div className="landing-streak-glow landing-streak-glow--lv4" aria-hidden />
            <Image
              src="/avatars/kai-level-4.webp"
              alt={t("landing.streak.kai_alt", { level: 4 })}
              width={280}
              height={280}
              className="landing-streak-kai landing-streak-kai--lv4"
            />
