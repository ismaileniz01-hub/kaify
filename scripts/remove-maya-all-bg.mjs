/**
 * Dr. Maya resimlerindeki TÜM arka planı temizler (yeşil + beyaz/gri)
 * Flood fill ile kenarlardan başlayarak tüm arka planı temizler.
 * Karakter üzerindeki renkleri korur.
 */
...
async function processFile(inputPath, outputPath) {
  ...
  // 2. AŞAMA: Çok geniş threshold ile flood fill
  const threshold = 80;
