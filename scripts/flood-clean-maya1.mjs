/**
 * dr maya 1.png flood fill ile temizler.
 * Sadece kenarlardan bağlantılı mavi pikselleri siler.
 * Karakterdeki mavi/beyaz tonlara dokunmaz.
 */
