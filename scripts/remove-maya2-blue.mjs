/**
 * Sadece dr maya 2.png'deki mavi arka planı temizler.
 * Flood fill ile kenarlardan başlayarak bağlantılı mavi alanları bulur.
 */
...
async function processFile(inputPath, outputPath) {
  ...
  // Mavi arka plan için: B > R ve B > G olan pikseller
  ...
  function isBlueBg(r, g, b) {
    ...
    // Çok parlak olmasın (beyazımsı mavi olmasın)
    if (r + g + b > 700) return false;
    // Çok koyu olmasın
    if (r + g + b < 50) return false;
    return true;
  }
...
const outputPath = join(root, "public", "avatars", "dr maya 2.png");
console.log("\nİşleniyor: dr maya 2.png");
