/**
 * dr maya 1.png ve dr maya 2.png flood fill ile güvenli temizlik.
 * Sadece kenar rengine (R=45 G=96 B=154) yakın olan ve kenarlardan bağlantılı pikselleri siler.
 * Mavi ton koşulu YOK - karakterdeki beyaz/mavi tonlara dokunmaz.
 */
...
async function processFile(inputPath, outputPath, label, avgR, avgG, avgB, threshold) {
  ...
  // Flood fill - sadece kenar rengine yakınlık kontrolü
...
// dr maya 1.png - mavi arka plan (kenar: R=45 G=96 B=154)
await processFile(
  join(root, "public", "avatars", "dr maya 1.png"),
  join(root, "public", "avatars", "dr maya 1.png"),
  "dr maya 1.png (güvenli flood fill)", 45, 96, 154, 80
);
...
await processFile(
  ...
  join(root, "public", "avatars", "dr maya 2.png"),
  "dr maya 2.png (güvenli flood fill)", 45, 96, 154, 80
);
